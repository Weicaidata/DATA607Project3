...
##Team Communication  
We created a private group in Slack to discuss and share opinions about our project.
We used Github and Rpubs to share code.
...
wordcloud(Corpus, min.freq = 10, colors = brewer.pal(8,"Dark2"),random.order = FALSE, rot.per = .25)
```
